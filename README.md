...
| [`0x0F-python-object_relational_mapping`](https://github.com/zezo773/alx-higher_level_programming/tree/master/0x0F-python-object_relational_mapping) | It aims to learn how to connect to a MySQL database from a Python script, understand ORM, and map a Python Class to a MySQL table |
| [`0x13-javascript_objects_scopes_closures`](https://github.com/zezo773/alx-higher_level_programming/tree/master/0x13-javascript_objects_scopes_closures) | It aims to teach how to use JavaScript objects, classes, inheritance, closures, and scope to write modular, reusable, and maintainable code in Node.js |
